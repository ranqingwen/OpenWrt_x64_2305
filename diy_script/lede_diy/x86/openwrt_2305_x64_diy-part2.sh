...
sed -i 's|<a href="https://github.com/jerrykuku/luci-theme-argon" target="_blank">ArgonTheme <%# vPKG_VERSION %></a>|<a class="luci-link" href="https://github.com/ranqingwen/Lede25-autobuild/releases" target="_blank">👆下载最新版本</a>|' package/luci-theme-argon/luasrc/view/themes/argon/footer.htm

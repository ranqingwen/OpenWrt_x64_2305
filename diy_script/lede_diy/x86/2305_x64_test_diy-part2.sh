...
# 添加插件
merge_package main https://github.com/gxnas/OpenWrt_Build_x64_Packages package/gxnas-packages luci-app-tailscale luci-app-poweroff luci-app-onliner luci-app-partexp luci-app-store luci-app-ssr-plus luci-app-serverchan luci-app-wechatpush
